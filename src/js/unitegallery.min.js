...
function UGAviaControl() {
    ...
    function i(e) {
        ...
        if (t > i)return !1;
        var n = g.offset(), r = n.top, o = e - r, a = h.thumb_height, s = t - h.thumb_height, l = s - a;
        a > o && (o = a), o > s && (o = s);
        var u = (o - a) / l, d = (i - t) * u;
    ...
    function n(e) {
        ...
        if (t > i)return !1;
        var n = g.offset(), r = n.left, o = e - r, a = h.thumb_width, s = t - h.thumb_width, l = s - a;
        a > o && (o = a), o > s && (o = s);
        var u = (o - a) / l, d = (i - t) * u;
        return d = Math.round(d), d = -1 * d
    }
...
function UGCarousel() {
    ...
    function g(e, t, i) {
        ...
        for (var r = [], o = 0; t > o; o++) {
            if ("prev" == i)var a = F.getPrevItem(n, !0); else var a = F.getNextItem(n, !0);
    ...
    function c() {
        var e = W.getElementSize(Q), t = W.getElementSize(H), i = t.width - e.width + t.left, n = X.sideSpace - i;
        return n
    }

    function h() {
        var e = -r(), t = X.sideSpace - e;
        return t
    }
    ...
    function I(e, t, i) {
        ...
        var n = u(e), r = W.getElementSize(n), o = -r.left + U.carousel_padding, a = {left: o + "px"};
        if (t === !0) {
    ...
    function E() {
        var e = -r(), t = s(e), i = W.getElementSize(u(t)).left, n = W.getElementSize(u(t + 1)).left;
    ...
    function S() {
        ...
        if (e > X.spaceActionSize)i = s(e), b(i, "left"), X.numCurrent += i; else if (e < -X.spaceActionSize) {
            var r = s(Math.abs(e));
    ...
    function C(e) {
        ...
        X.lastMousePos = o(e);
        var i = X.lastMousePos - X.startMousePos, n = X.startInnerPos + i, r = i > 0 ? "prev" : "next", a = W.getElementSize(H).width;
    ...
    function N() {
        var e = X.lastTime - X.startTime, t = Math.abs(X.lastMousePos - X.startMousePos);
        return e > 300 ? !1 : t > 30 ? !1 : !0
    }

    var k, L, R, Q, H, G = this, D = jQuery(this), F = new UniteGalleryMain, W = new UGFunctions, B = new UGTileDesign, Y = new UGThumbsGeneral, U = {
        carousel_padding: 8,
...
function UGFunctions() {
    ...
    this.debugVar = "", this.z__________FULL_SCREEN___________ = function () {
        ...
        if (!r)var r = e.parent();
        var o = i.getElementSize(e), a = i.getElementSize(r);
        switch (t) {
            case"top":
            case"left":
                t = 0, n && (t += n);
        ...
        var n = t.outerWidth(), r = t.outerHeight(), o = i.getImageOriginalSize(e), a = o.width, s = o.height, l = a / s, u = r, d = u * l, _ = 0, g = 0;
...
function UniteGalleryMain() {
    ...
    function setHtmlObjectsProperties() {
        var e = g_functions.getCssSizeParam(g_options.gallery_width), t = {
            "max-width": e,
    ...
    function fillItemsArray(e) {
        ...
        for (var t = 0, i = 0; i < e.length; i++) {
            var n = jQuery(e[i]), r = n.prop("tagName").toLowerCase(), o = "";
            if ("a" == r) {
            ...
            void 0 == a && (a = "image");
            var s = {};
            if (s.type = a, "img" == r)s.urlThumb = n.attr("src"), s.title = n.attr("alt"), s.objThumbImage = n; else {
            ...
            var l = void 0 == s.urlImage || "" == s.urlImage, u = void 0 == s.urlThumb || "" == s.urlThumb;
            switch (s.type) {
                case"youtube":
    ...
    var t = this, g_galleryID, g_objGallery = jQuery(t), g_objWrapper, g_objThumbs, g_objSlider, g_functions = new UGFunctions, g_objTabs, g_arrItems = [], g_numItems, g_selectedItem = null, g_selectedItemIndex = -1, g_objTheme, g_objCache = {};
    this.events = {
    ...
    this.onItemBigImageLoaded = function (e, t) {
        ...
        if (t && t.hasOwnProperty("gallery_debug_errors") && (g_options.gallery_debug_errors = t.gallery_debug_errors), 1 == g_options.gallery_debug_errors)try {
            ...
            if ("object" == typeof i) {
                {
                    var n = i, r = i.lineNumber, o = i.fileName;
                    i.stack
                }
...
function UGGridPanel() {
    ...
    function a() {
        var e = M.gridpanel_padding_border_top + M.gridpanel_padding_border_bottom, t = N.panelHeight - e;
    ...
    function s() {
        var e = M.gridpanel_padding_border_left + M.gridpanel_padding_border_right, t = N.panelWidth - e;
        if (0 == M.gridpanel_arrows_always_on) {
    ...
    var w, I, E, T, S = this, P = jQuery(this), x = new UniteGalleryMain, j = new UGFunctions, C = new UGThumbsGrid, A = new UGPanelsBase;
    ...
    }, z = {gridpanel_grid_align: "center"}, N = {
        panelType: "grid",
        isHorType: !1,
        arrowsVisible: !1,
        panelHeight: 0,
...
function UGLightbox() {
    ...
    function r(e) {
        if (!et)return !0;
        var t = {slider_image_padding_top: e, slider_video_padding_top: e};
    ...
    function o() {
        ...
        var e = K.height();
        if (0 == e)return !1;
        var t = e, i = it.getSize().height;
        e != rt.topPanelHeight && (t = rt.topPanelHeight), i > t && (t = i), e != t && (K.height(t), et && 0 == et.isAnimating() && r(t))
    }

    function a(e) {
        var t = {}, i = nt.lightbox_textpanel_width, n = 47, r = 40, a = e.width - n - r;
    ...
    function s(e) {
        ...
        if (!it)return !1;
        if (!et)return !1;
        var t = tt.getElementSize(Y), i = it.getSize();
        if (0 == i.width || i.height > 120)return !1;
        if (!e)var n = et.getSlideImage(), e = tt.getElementSize(n);
        if (0 == e.height || 0 == e.width)return !1;
        var r = e.bottom + i.height;
        if (r < t.height)return !1;
        var o = et.getOptions(), a = i.height;
    ...
    function l(e, t) {
        if (!e)var i = et.getSlideImage(), e = tt.getElementSize(i);
        rt.textPanelTop = e.bottom, t === !0 && it.positionPanel(rt.textPanelTop, rt.textPanelLeft)
    }

    function u(e) {
        var t = (tt.getElementSize(Y), et.getSlideImage()), i = tt.getElementSize(t);
    ...
    function _(e, t) {
        ...
        if (!X)return !1;
        var i = d();
        if (X.show(), V.show(), rt.positionFrom = "positionArrowsInside", 1 == rt.isArrowsOnHoverMode && 1 == i && 0 == v() && b(!0), 0 == i)var n = tt.getElementRelativePos(X, "left", nt.lightbox_arrows_offset), r = tt.getElementRelativePos(X, "middle"), o = tt.getElementRelativePos(V, "right", nt.lightbox_arrows_offset), a = r; else var s = et.getSlideImage(), l = tt.getElementSize(s), n = (tt.getElementSize(et.getElement()), tt.getElementRelativePos(X, "left", 0, s) + l.left + nt.lightbox_arrows_inside_offset), r = tt.getElementRelativePos(X, "middle", 0, s) + l.top, o = tt.getElementRelativePos(X, "right", 0, s) + l.left - nt.lightbox_arrows_inside_offset, a = r;
        if (t === !0) {
            var u = {left: n, top: r}, _ = {left: o, top: a};
            X.stop().animate(u, {duration: rt.fadeDuration}), V.stop().animate(_, {duration: rt.fadeDuration})
    ...
    function g(e, t) {
        ...
        var i = d(), n = 2, r = tt.getElementRelativePos(Z, "right", 2, Y);
        if (0 == i)var o = n, a = r; else {
            var s = et.getSlideImage(), l = tt.getElementSize(s), u = tt.getElementSize(et.getElement()), _ = tt.getElementSize(Z);
            u.top == u.height && (u.top = 0);
            var a = u.left + l.right - _.width / 2 + nt.lightbox_compact_closebutton_offsetx, o = u.top + l.top - _.height / 2 - nt.lightbox_compact_closebutton_offsety;
            n > o && (o = n), a > r && (a = r)
        }
        if (t === !0) {
            var g = {left: a, top: o};
            Z.stop().animate(g, {duration: rt.fadeDuration})
    ...
    function p() {
        ...
        if (et) {
            if (K) {
                var o = K.height(), s = {slider_image_padding_top: o, slider_video_padding_top: o};
                et.setOptions(s)
            }
    ...
    function v() {
        ...
        var e = {pageX: rt.lastMouseX, pageY: rt.lastMouseY}, t = et.isMouseInsideSlideImage(e);
        return t
    }
    ...
    function M() {
        var e = et.getOptions(), t = e.slider_image_padding_top;
        if (K) {
            var i = K.height();
            i != t && r(i)
        }
    ...
    var B, Y, U, X, V, Z, q, K, J = this, $ = (jQuery(this), new UniteGalleryMain), et = new UGSlider, tt = new UGFunctions, it = new UGTextPanel, nt = {
        lightbox_type: "wide",
...
function UGSlider() {
    function e(e, t, n) {
        ...
        if (tt = r.g_objWrapper, it = r.g_objThumbs, t.hasOwnProperty("slider_progress_indicator_type") && (Tt.slider_progress_indicator_type = t.slider_progress_indicator_type), "bar" == Tt.slider_progress_indicator_type && (Tt = jQuery.extend(Tt, St)), t && ht.setOptions(t), i(), 1 == Tt.slider_enable_bullets) {
            bt = new UGBullets;
            var o = {bullets_skin: Tt.slider_bullets_skin, bullets_space_between: Tt.slider_bullets_space_between};
            bt.init(ft, o)
        }
    ...
    function i() {
        var e = ft.getOptions(), t = e.gallery_skin;
    ...
    function r(e) {
        e && (tt = e);
        var t = V(), i = (ft.getOptions(), "<div class='ug-slider-wrapper'>");
    ...
    function l() {
        var e, t, i, n, r = ht.getSlidesReference(), o = 0, a = 0, s = 0;
    ...
    function c(e, t) {
        var i = Tt.slider_video_constantsize_width, n = Tt.slider_video_constantsize_height, r = Tt.slider_video_constantsize_scalemode;
        wt.scaleImageExactSizeInParent(e, t.imageWidth, t.imageHeight, i, n, r)
    }

    function h(e, t, i) {
        var n = e.children(".ug-item-wrapper"), r = K(e), o = t.urlImage, a = e.data("urlImage");
        e.data("urlImage", o);
        var s = ht.getScaleMode(e), l = ht.getSlideType(e);
        if (objPadding = ht.getObjImagePadding(), a == o && i !== !0) {
            ...
            e.fadeTo(0, 1);
            var i = e.parent().parent(), n = ht.getSlideType(i), r = K(i), o = ht.getObjImagePadding(), a = ht.getScaleMode(i);
    ...
    function v() {
        var e = Et.getElement(), t = e.data("isHidden");
        return t === !1 ? !1 : !0
    }
    ...
    function y() {
        var e = ht.getCurrentSlide(), t = ht.getSlideImage(e), i = wt.getElementSize(e), n = i.left, r = i.top;
    ...
    function w() {
        var e = Tt.slider_video_constantsize_width, t = Tt.slider_video_constantsize_height;
        yt.setSize(e, t);
        var i = yt.getObject();
        g(i)
    }
    ...
    function E(e, t) {
        ...
        switch (e) {
            case"right":
                ...
                var r = wt.getElementSize(n.objPrevSlide), o = -r.left;
                ht.switchSlideNums("right");
                break;
            case"left":
                p(n.objNextSlide, t), l();
                var a = wt.getElementSize(n.objNextSlide), o = -a.left;
                ht.switchSlideNums("left");
                break;
            default:
                throw new Error("wrong direction: " + e)
        }
        var s = Tt.slider_transition_speed, u = Tt.slider_transition_easing, d = {
            duration: s,
            easing: u,
            queue: !1,
            always: function () {
    ...
    function S(e, t, i) {
        ...
        var o = Pt.numCurrent;
        if (Pt.numCurrent = Pt.numNext, Pt.numNext = o, pt.trigger(ht.events.ITEM_CHANGED), n.objNextSlide.stop(!0), n.objCurrentSlide.stop(!0), 1 == t)n.objCurrentSlide.fadeTo(0, 0), n.objNextSlide.fadeTo(0, 1), ht.placeNabourItems(), pt.trigger(ht.events.TRANSITION_END), i !== !0 && yt.hide(); else {
    ...
    function R() {
        var e = ht.getCurrentSlide(), t = e.hasClass("ug-slide-clickable"), i = ht.getCurrentItem();
    ...
    function Y(e, t) {
        t = jQuery(t);
        var i = ht.getSlideImage(t), n = J(t), r = wt.getElementSize(i);
    ...
    function q(e) {
        var t = ht.getSlidesReference(), i = t.objCurrentSlide.data("index"), n = e.index, r = "left";
    ...
    var et, tt, it, nt, rt, ot, at, st, lt, ut, dt, _t, gt, ct, ht = this, pt = jQuery(ht), ft = new UniteGalleryMain, mt = null, vt = null, bt = null, yt = new UGVideoPlayer, wt = new UGFunctions, It = null, Et = null;
    this.events = {
    ...
    this.switchSlideNums = function (e) {
        ...
        var e = ht.getSlidesReference(), t = wt.getElementSize(e.objCurrentSlide), i = -t.left, n = wt.getElementSize(rt);
        return i == n.left ? !0 : !1
        ...
        var e = {objPrevSlide: Z(Pt.numPrev), objNextSlide: Z(Pt.numNext), objCurrentSlide: Z(Pt.numCurrent)};
        return e
    }, this.getCurrentSlide = function () {
        var e = ht.getSlidesReference();
        return e.objCurrentSlide
    }, this.getCurrentItemIndex = function () {
        var e = ht.getSlidesReference(), t = e.objCurrentSlide.data("index");
        ...
        var t = ht.getSlideImage(), i = wt.getMousePosition(e);
        void 0 === i.pageX && (i = dt.getLastMousePos());
        var n = wt.getMouseElementPoint(i, t), r = wt.getElementSize(t);
        return isMouseInside = wt.isPointInsideElement(n, r)
    }, this.isCurrentSlideType = function (e) {
        var t = ht.getSlideType();
        return t == e ? !0 : !1
    }, this.isCurrentSlideLoadingImage = function () {
        var e = ht.getCurrentSlide(), t = e.data("isLoading");
        return t === !0 ? !0 : !1
    }, this.setItem = function (e, t) {
        var i = ht.getSlidesReference(), n = i.objCurrentSlide.data("index"), r = e.index;
        if (r == n)return !0;
        var o = void 0 == n;
        if (o)p(i.objCurrentSlide, e), ht.placeNabourItems(); else {
            var a = "left", s = ft.getNumItems();
            n == s - 1 && 0 == r ? a = "left" : 0 == n && r == s - 1 ? a = "right" : n > r && (a = "right"), I(a, e, t)
        }
    }, this.placeNabourItems = function () {
        var e = ht.getSlidesReference(), t = e.objCurrentSlide.data("index"), i = ft.getPrevItem(t), n = ft.getNextItem(t);
        ...
        var e = {g_objSlider: nt, g_objInner: rt, g_options: Tt, g_objZoomSlider: _t};
        return e
        ...
        var t = ht.getScaleMode(), i = ht.getObjImagePadding(), n = $(), r = e.parent(), o = wt.getImageInsideParentData(r, n.imageWidth, n.imageHeight, t, i), a = wt.getElementSize(e);
        ...
        var o = e - Tt.slider_item_padding_left - Tt.slider_item_padding_right, s = t - Tt.slider_item_padding_top - Tt.slider_item_padding_bottom, d = {};
        ...
        if ("image" != _ && 1 == Tt.slider_video_constantsize)w(); else {
            var g = e - Tt.slider_video_padding_left - Tt.slider_video_padding_right, c = t - Tt.slider_video_padding_top - Tt.slider_video_padding_bottom;
            yt.setSize(g, c)
        }
        a(), u(ot), u(at), u(st), l()
...
function UGTextPanel() {
    ...
    this.positionElements = function (t) {
        ...
        var i = {};
        if (void 0 !== e && null !== e)i.top = e; else switch (v.textpanel_align) {
            case"top":
...
function UGBullets() {
    function e() {
        var e = "", t = "";
        -1 != c.bullets_space_between && (t = " style='margin-left:" + c.bullets_space_between + "px'");
    ...
    var o, a, s = this, l = 0, u = new UniteGalleryMain, d = -1, _ = new UGFunctions, g = {isInited: !1}, c = {
        bullets_skin: "",
        bullets_addclass: "",
...
function UGProgressBar() {
    var e, t, i = this, n = 0, r = new UGFunctions, o = {
...
function UGStripPanel() {
    ...
    function f() {
        ...
        if (M.isEventsInited = !0, y)if (S.addClassOnHover(y, "ug-button-hover"), S.addClassOnHover(w, "ug-button-hover"), S.setButtonOnClick(w, g), S.setButtonOnClick(y, _), "advance_item" != j.strippanel_buttons_role)jQuery(P).on(P.events.STRIP_MOVE, h), m.on(T.events.SIZE_CHANGE, c); else {
            var e = T.getOptions();
    ...
    var m, v, b, y, w, I = this, E = jQuery(this), T = new UniteGalleryMain, S = new UGFunctions, P = new UGThumbsStrip, x = new UGPanelsBase;
    this.events = {FINISH_MOVE: "gridpanel_move_finish", OPEN_PANEL: "open_panel", CLOSE_PANEL: "close_panel"};
    var j = {
...
function UGTabs() {
    ...
    function n() {
        var e = l.tabs_class_selected, t = jQuery(this);
    ...
    var o, a, s = (jQuery(this), new UniteGalleryMain), l = (new UGFunctions, {
...
function UGThumbsGeneral() {
    function e(e, t, i, n) {
        var r = {width: e + "px", height: t + "px"}, o = {
    ...
    function n(e, t, i) {
        var n = e.children("img.ug-thumb-image"), r = e.children("img.ug-thumb-image-overlay"), o = x.thumb_transition_duration;
    ...
    var v, b, y, w, I, E = this, T = jQuery(E), S = new UniteGalleryMain, P = new UGFunctions;
    this.events = {
    ...
    this.init = function (e, t) {
        ...
        for (var n = 0; t > n; n++) {
            ...
            var u = jQuery(a), d = r.objThumbImage;
            if (0 == j.customThumbs) {
...
function UGThumbsGrid() {
    ...
    function o() {
        var e = Q.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerHeight(), n = U.gridWidth, r = Y.grid_num_rows * i + (Y.grid_num_rows - 1) * Y.grid_space_between_rows + 2 * Y.grid_padding;
        U.gridHeight = r, F.setElementSize(R, n, r), F.setElementSize(Q, n, r), U.innerWidth = n, U.innerHeight = r
    }

    function a() {
        var e = Q.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = Y.grid_num_cols * i + (Y.grid_num_cols - 1) * Y.grid_space_between_cols + 2 * Y.grid_padding, r = U.gridHeight;
    ...
    function d() {
        var e = Q.children(".ug-thumb-wrapper"), t = 0, n = 0, r = 0, o = 0, a = 0, s = 0;
    ...
    function g() {
        var e = Q.children(".ug-thumb-wrapper"), t = Y.grid_padding, n = Y.grid_padding, r = n, o = t, a = 0, s = 0, l = 0, u = 0;
        U.innerWidth = 0, U.numPanes = 1, U.arrPanes = [], U.numThumbsInPane = 0, U.arrPanes.push(t - Y.grid_padding);
        var d = e.length;
        for (i = 0; d > i; i++) {
            var _ = jQuery(e[i]), g = _.outerWidth(), c = _.outerHeight();
    ...
    function E() {
        ...
        var e = F.getStoredEventData(U.storedEventID), t = e.diffTime, i = w(), n = Math.abs(i - e.startInnerPos);
        return n > 30 ? !0 : n > 5 && t > 300 ? !0 : !1
    }

    function T() {
        var e = F.getStoredEventData(U.storedEventID), t = w();
        diffPos = Math.abs(e.startInnerPos - t);
        var i = b(), n = Math.round(3 * i / 8);
    ...
    function P() {
        if (1 == E())return !0;
        var e = jQuery(this), t = W.getItemByThumb(e);
        D.selectItem(t)
    }
    ...
    function C(e) {
        ...
        var t = F.getStoredEventData(U.storedEventID, U.isNavigationVertical), i = j();
        if (i)return !0;
        var n = t.diffMousePos, r = t.startInnerPos + n, o = n > 0 ? "prev" : "next", a = U.arrPanes[U.numPanes - 1];
    ...
    function A(e) {
        ...
        var i = w(), n = i - t.startInnerPos, r = n > 0 ? "prev" : "next";
    ...
    var z, N, k, L, R, Q, H = this, G = jQuery(this), D = new UniteGalleryMain, F = new UGFunctions, W = new UGThumbsGeneral, B = new UGTileDesign, Y = {
    ...
    this.destroy = function () {
        ...
        if (1 == U.isTilesMode)var t = Y.tile_height; else var i = W.getOptions(), t = i.thumb_height;
        var n = W.getNumThumbs(), r = Math.ceil(n / Y.grid_num_cols), o = r * t + (r - 1) * Y.grid_space_between_rows, a = Math.ceil(o / e);
        return a
    }, this.getNumPanesEstimationByWidth = function (e) {
        if (U.isTilesMode)var t = Y.tile_width; else var i = W.getOptions(), t = i.thumb_width;
        var n = W.getNumThumbs(), r = Math.ceil(n / Y.grid_num_rows), o = r * t + (r - 1) * Y.grid_space_between_cols, a = Math.ceil(o / e);
        return a
    }, this.getHeightEstimationByWidth = function (e) {
        if (0 == U.isTilesMode)throw new Error("This function works only with tiles mode");
        var t = W.getNumThumbs(), i = F.getNumItemsInSpace(e, Y.tile_width, Y.grid_space_between_cols), n = Math.ceil(t / i);
        ...
        var e = {pane: U.currentPane, total: U.numPanes};
        return e
...
function UGThumbsStrip() {
    ...
    function r() {
        var e = x.children(".ug-thumb-wrapper"), t = jQuery(e[0]), i = t.outerWidth(), n = t.outerHeight(), r = N.getOptions();
    ...
    function a() {
        var e = x.children(".ug-thumb-wrapper"), t = 0, n = 0;
        ...
        if (0 == z)var a = t - k.strip_space_between_thumbs; else var a = n - k.strip_space_between_thumbs;
        o(a)
    }

    function s() {
        if (0 == z) {
            var e = R.thumbSecondSize, t = {};
            t.height = e + "px";
            var i = {};
            i.height = e + "px"
        } else {
            var n = R.thumbSecondSize, t = {};
            t.width = n + "px";
            var i = {};
            i.width = n + "px"
        }
    ...
    function l(e) {
        var t = A.getInnerStripPos(), i = t + e;
    ...
    function d(e) {
        var t = w(e), i = -1 * t.max + R.stripSize;
        i = A.fixInnerStripLimits(i), A.positionInnerStrip(i, !0)
    }
    ...
    function c() {
        if (0 == b())return !1;
        var e = A.getInnerStripPos(), t = A.fixInnerStripLimits(e);
    ...
    var I, E, T, S, P, x, j, C, A = this, M = new UniteGalleryMain, O = new UGFunctions, z = !1, N = new UGThumbsGeneral, O = new UGFunctions, k = {
    ...
    }, L = {isRunOnce: !1, is_placed: !1, isNotFixedThumbs: !1, handle: null}, R = {
        stripSize: 0,
        stripInnerSize: 0,
        thumbSize: 0,
        thumbSecondSize: 0
    ...
    var Q = {strip_thumbs_align: "top", thumb_resize_by: "width"};
    this.setHtml = function (e) {
        if (!e) {
            var e = T;
        ...
        if (void 0 === t)var t = !1;
        if (0 == z)var i = {left: e + "px"}; else var i = {top: e + "px"};
        ...
        var t = e.objThumbWrapper, i = t.position(), n = -1 * A.getInnerStripPos();
        if (0 == z)var r = n + P.width(), o = i.left, a = i.left + t.width(); else var r = n + P.height(), o = i.top, a = i.top + t.height();
        var s = !1;
...
function UGTileDesign() {
    ...
    function i(e, t) {
        ...
        if (z.tile_enable_icons) {
            ...
            if (0 == l && "image" != t.type && 1 == z.tile_videoplay_icon_always_on && (l = !0), l)var u = e; else var u = e.children(".ug-thumb-overlay");
            u.append(o);
            var d = u.children("." + a);
        ...
        if (1 == z.tile_enable_image_effect) {
            var g = "<div class='ug-tile-image-overlay' style='display:none'>", c = " ug-" + z.tile_image_effect_type + "-effect";
    ...
    function _(e) {
        var t = (j.getItemByTile(e), l(e)), i = s(e), u = M.getElementSize(e), d = n(e), _ = j.getTileImage(e), g = r(e);
        ...
        if (1 == z.tile_enable_textpanel && c && (c.refresh(!1, !0), (1 == z.tile_textpanel_always_on || "fade" == z.tile_textpanel_appear_type) && c.positionPanel()), t || i) {
            var h = 0;
            if (1 == z.tile_enable_textpanel) {
                var p = a(e), f = M.getElementSize(p);
                f.height > 0 && (h = Math.floor(f.height / 2 * -1))
            }
        }
        if (t && i) {
            var m = M.getElementSize(t), v = M.getElementSize(i), b = z.tile_space_between_icons, y = m.width + b + v.width, w = Math.floor((u.width - y) / 2);
    ...
    function g(e, t) {
        var i = (j.getItemByTile(e), n(e)), r = z.thumb_transition_duration;
    ...
    function c(e, t) {
        var i = z.thumb_transition_duration, n = a(e);
        if (!n)return !0;
        if ("slide" == z.tile_textpanel_appear_type) {
            var r = M.getElementSize(n);
            if (0 == r.width)return !1;
            var o = -r.height, s = 0;
            1 == t ? (n.fadeTo(0, 1), 0 == n.is(":animated") && n.css("bottom", o + "px"), n.stop(!0).animate({bottom: s + "px"}, i)) : n.stop(!0).animate({bottom: o + "px"}, i)
    ...
    function p(e, t) {
        if (t = jQuery(t), z.tile_enable_image_effect && g(t, !0), 1 == z.tile_enable_textpanel && 0 == z.tile_textpanel_always_on && c(t, !0), k.isSaparateIcons && 1 == z.tile_enable_icons) {
            var i = 1 == z.thumb_overlay_reverse, n = j.getItemByTile(t);
    ...
    function w(e) {
        ...
        if (k.funcParentApproveClick && 0 == k.funcParentApproveClick() && (n = !1), "a" == i)0 == n && e.preventDefault(); else if (0 == u(t))1 == n && y(t); else {
            if (0 == d(t))return !0;
    ...
    var T, S, P, x, j = this, C = jQuery(this), A = new UniteGalleryMain, M = new UGFunctions, O = new UGThumbsGeneral;
    ...
    this.loadTileImage = function (e) {
        ...
        if (1 == k.isFixedMode) {
            ...
            } else var t = z.tile_width, i = z.tile_height;
        ...
        var i = j.getItemByTile(e), n = t * i.thumbRatioByHeight;
...
function UGTiles() {
    ...
    function d(e, t, i, n) {
        ...
        var o = A.getTileHeightByWidth(e, O.colWidth), a = O.arrPosx[n];
    ...
    function g(e) {
        var t = e.index(), i = C.getPrevRowSameColIndex(t, O.numCols);
        if (0 > i)return !0;
        var n = j.getItem(i);
    ...
    function c(e, t) {
        ...
        var n = e.index(), r = C.getColByIndex(O.numCols, n);
        d(e, !0, !0, r);
        var o = j.getItem(n);
        o.ordered_placed = !0, e.fadeTo(0, 1), A.triggerSizeChangeEvent(e);
        var a = j.getNumItems(), s = C.getNextRowSameColIndex(n, O.numCols);
        if (s >= a)return !1;
        var l = M.getThumbByIndex(s), u = j.getItem(s);
    ...
    function p() {
        ...
        if (1 == z.tiles_set_initial_height && 0 == C.isScrollbarExists() && 25 > t) {
            var i = (e.length, Math.ceil(e.length / O.numCols)), r = i * z.tiles_col_width * .75;
            T.height(r), l()
        }
        e.css("width", O.colWidth + "px"), e.fadeTo(0, 0);
        var o = O.numCols, a = O.galleryWidth, s = jQuery(T).find("img.ug-thumb-image"), u = !1;
    ...
    function f() {
        var e = r(), t = M.getThumbs(), i = z.tiles_justified_row_height, n = [], o = 0, a = z.tiles_justified_space_between, s = t.length;
        jQuery.each(t, function (e, t) {
            t = jQuery(t);
            var r = (A.getTileImage(t), M.getItemByThumb(t)), a = r.thumbWidth, s = r.thumbHeight;
    ...
    function m(e) {
        ...
        jQuery.each(i.arrRows, function (t, n) {
            var r = i.arrRowWidths[t], o = i.arrRowHeights[t], a = 0;
    ...
    function v() {
        var e = jQuery(E).find("img.ug-thumb-image"), t = M.getThumbs();
    ...
    var I, E, T, S, P = this, x = jQuery(this), j = new UniteGalleryMain, C = new UGFunctions, A = new UGTileDesign, M = new UGThumbsGeneral, O = {}, z = {
        tiles_type: "columns",
        tiles_col_width: 250,
        tiles_align: "center",
        tiles_exact_width: !1,
    ...
    this.events = {THUMB_SIZE_CHANGE: "thumb_size_change", TILES_FIRST_PLACED: "tiles_first_placed"};
    var N = {isFirstTimeRun: !0, handle: null, isTransActive: !1, arrWaitList: []};
    this.destroy = function () {
...
function UGTouchSliderControl() {
    ...
    function i(e) {
        ...
        h.animate({left: i + "px"}, {
            ...
            progress: function () {
                if (1 == b.isDragVideo) {
                    var e = v.getElementSize(h), t = e.left, n = t - i, r = b.videoStartX + n;
...
function UGTouchThumbsControl() {
    ...
    function a() {
        ...
        var I = c - _, S = Math.abs(Math.round(u / e));
        if (0 != d && (S = S * I / d), _ != c) {
            var P = {left: c + "px"};
            1 == w && (P = {top: c + "px"}), b.animate(P, {
                duration: S,
    ...
    var h, p, f, m, v, b, y, w, I = new UGFunctions, E = {
...
function UGYoutubeAPI() {
    ...
    this.events = {START_PLAYING: "start_playing", STOP_PLAYING: "stop_playing"}, this.setOptions = function (e) {
        _ = jQuery.extend(_, e)
...
function UGVideoPlayer() {
    ...
    var o, a, s, l, u, d, _, g, c = this, h = jQuery(this), p = new UGFunctions, f = new UGYoutubeAPI, m = new UGVimeoAPI, v = new UGHtml5MediaAPI, b = new UGSoundCloudAPI, y = new UGWistiaAPI, w = null, I = {video_enable_closebutton: !0};
    this.events = {
        SHOW: "video_show",
        HIDE: "video_hide",
...
function UGZoomSliderControl() {
    ...
    function f(e) {
        ...
        if (1 == P.isZoomActive ? _(e) : g(e), 1 == P.isZoomActive)0 == P.isPanActive; else {
    ...
    function v(e, t) {
        ...
        if (0 == E.isCurrentSlideType("image"))return !0;
        e.preventDefault();
        var i = t > 0, r = T.getMousePosition(e), o = 1 == i ? "in" : "out";
        n(o, r)
    }
    ...
    var y, w, I, E = new UGSlider, T = new UGFunctions, S = {
